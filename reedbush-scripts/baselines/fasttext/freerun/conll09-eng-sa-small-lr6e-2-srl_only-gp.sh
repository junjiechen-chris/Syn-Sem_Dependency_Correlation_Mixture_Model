...
JOB_NAME="CONLL09-eng-SA-SMALL-fasttext-PX3-srl_only-GP"
SAVEDIR=.model/baselines/fasttext/freerun/conll09-eng-sa-small-srl_only-lr_6e-2-gp
CONF=config/baselines/fasttext/conll09-eng-sa-small-srl_only-gp.conf
