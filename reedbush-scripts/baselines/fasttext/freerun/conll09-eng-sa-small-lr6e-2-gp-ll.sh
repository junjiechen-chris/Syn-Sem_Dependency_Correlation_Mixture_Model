...
JOB_NAME="CONLL09-eng-SA-SMALL-fasttext-GP-ll"
SAVEDIR=.model/baselines/fasttext/freerun/conll09-eng-sa-small-lr_6e-2-gp-ll
CONF=config/baselines/fasttext/conll09-eng-sa-small-gp-ll.conf
