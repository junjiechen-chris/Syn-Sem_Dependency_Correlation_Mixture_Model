...
JOB_NAME="CONLL09-eng-SA-SMALL-bert-PX3-srl_only-GP"
SAVEDIR=.model/baselines/bert/freerun/conll09-eng-sa-small-srl_only-lr_6e-2-gp
CONF=config/baselines/bert/conll09-eng-sa-small-srl_only-gp.conf
