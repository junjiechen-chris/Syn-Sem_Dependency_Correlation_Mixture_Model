...
JOB_NAME="CONLL09-eng-SA-SMALL-bert-PX3-GP-ll"
SAVEDIR=.model/baselines/bert/freerun/conll09-eng-sa-small-lr_6e-2-gp-ll
CONF=config/baselines/bert/conll09-eng-sa-small-gp-ll.conf
