...
JOB_NAME="CONLL09-ger-SA-SMALL-bert-PX3-GP-ll"
SAVEDIR=.model/baselines/bert/freerun/conll09-ger-sa-small-lr_6e-2-gp-ll
CONF=config/baselines/bert/conll09-ger-sa-small-gp-ll.conf
