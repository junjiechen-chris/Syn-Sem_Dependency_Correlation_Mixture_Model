...
JOB_NAME="CONLL09-eng-SA-SMALL-glove_100d-srl_only-GP"
SAVEDIR=.model/baselines/glove_100d/freerun/conll09-eng-sa-small-srl_only-lr_6e-2-gp
CONF=config/baselines/glove_100d/conll09-eng-sa-small-srl_only-gp.conf
