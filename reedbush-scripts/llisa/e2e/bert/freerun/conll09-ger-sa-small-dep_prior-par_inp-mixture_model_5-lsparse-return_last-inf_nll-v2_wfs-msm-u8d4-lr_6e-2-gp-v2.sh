...
JOB_NAME="conll09-ger-bert-sa-small-dep_prior-par_inp-mixture_model_5-lsparse-return_last-inf_nll-v2_wfs-msm-u8d4-lr_6e-2-gp-v2"
SAVEDIR=.model/llisa/e2e/bert/freerun/conll09-ger-sa-small-dep_prior-par_inp-mixture_model_5-lsparse-return_last-inf_nll-v2_wfs-msm-u8d4-lr_6e-2-gp-v2
CONF=config/llisa/e2e/bert/conll09-ger-sa-small-dep_prior-par_inp-bilinear-gp.conf
