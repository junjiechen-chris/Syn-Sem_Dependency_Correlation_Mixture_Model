...
JOB_NAME="conll09-sa-small-dep_prior-par_inp-mixture_model_5-lsparse-return_last-inf_nll-v2_wfs-msm-u8d4-lr_6e-2-add_exclusion_dist-px3-gp-elmo-v2"
SAVEDIR=.model/llisa/e2e/elmo/freerun/conll09-sa-small-dep_prior-par_inp-mixture_model_10-lsparse-return_last-inf_nll-v2_wfs-msm-u8d4-lr_6e-add_exclusion_dist-2-px3-gp-v2
...
source reedbush-scripts/llisa/hparam_str/mixture_model_10.sh
...
source reedbush-scripts/llisa/hparam_str/add_exclusion_dist.sh
echo $HPARAMS_STR
ADDITIONAL_PARAMETERS="--hparams  "$HPARAMS_STR"$3 --use_llisa_proj"
echo $ADDITIONAL_PARAMETERS
source reedbush-scripts/llisa/run_experiment_hm_2.sh
