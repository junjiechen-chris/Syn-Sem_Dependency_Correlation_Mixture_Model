...
JOB_NAME="conll09-sa-small-dep_prior-par_inp-mixture_model_5-lsparse-return_last-inf_gumbel-v2_wfs-msm-lr_4e-2-px3-gp"
SAVEDIR=.model/llisa/e2e/elmo/freerun/conll09-sa-small-dep_prior-par_inp-mixture_model_5-return_last-inf_gumbel-v2_wfs-msm-lr_4e-2-px3-gp
