...
JOB_NAME="conll09-sa-small-dep_prior-par_inp-mixture_model_embedding_5-msm-return_last-inf_gumbel-v2_wfs-use_lstm-use_dep_label-use_lexicons-lr_6e-2-px3-gp"
SAVEDIR=.model/llisa/e2e/elmo/freerun/conll09-sa-small-pathlstm-lr_6e-2-px3-gp
