...
JOB_NAME="conll09-sa-small-dep_prior-par_inp-mixture_model_5-lsparse-return_last-inf_nll-v2_wfs-msm-u8d4-lr_4e-2-px3-gp-elmo-v2"
SAVEDIR=.model/llisa/e2e/elmo/freerun/conll09-sa-small-dep_prior-par_inp-mixture_model_5-lsparse-return_last-inf_nll-v2_wfs-msm-u8d4-lr_4e-2-px3-gp-v2
