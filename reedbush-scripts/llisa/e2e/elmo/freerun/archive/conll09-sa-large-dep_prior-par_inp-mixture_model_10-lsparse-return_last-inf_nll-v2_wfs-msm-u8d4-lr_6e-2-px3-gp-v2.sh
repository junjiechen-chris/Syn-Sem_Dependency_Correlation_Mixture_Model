...
JOB_NAME="conll09-sa-large-dep_prior-par_inp-mixture_model_5-lsparse-return_last-inf_nll-v2_wfs-msm-u8d4-lr_6e-2-px3-gp-elmo-v2"
SAVEDIR=.model/llisa/e2e/elmo/freerun/conll09-sa-large-dep_prior-par_inp-mixture_model_10-lsparse-return_last-inf_nll-v2_wfs-msm-u8d4-lr_6e-2-px3-gp-v2
CONF=config/llisa/e2e/elmo/conll09-sa-large-dep_prior-par_inp-bilinear-px3-gp.conf
