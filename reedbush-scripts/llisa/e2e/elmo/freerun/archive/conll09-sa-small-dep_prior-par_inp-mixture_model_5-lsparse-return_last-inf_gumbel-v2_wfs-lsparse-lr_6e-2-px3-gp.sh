...
JOB_NAME="conll09-sa-small-dep_prior-par_inp-mixture_model_5-lsparse-return_last-inf_gumbel-v2_wfs-msm-lr_6e-2-px3-gp"
SAVEDIR=.model/llisa/e2e/elmo/freerun/conll09-sa-small-dep_prior-lsparse-par_inp-mixture_model_5-return_last-inf_gumbel-v2_wfs-lr_6e-2-px3-gp
CONF=config/llisa/e2e/elmo/conll09-sa-small-dep_prior-lsparse-par_inp-bilinear-px3-gp.conf
...
#source reedbush-scripts/llisa/hparam_str/fixed_seed.sh
...
source reedbush-scripts/llisa/run_experiment_hm_gs.sh
